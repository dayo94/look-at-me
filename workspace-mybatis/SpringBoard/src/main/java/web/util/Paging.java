...
public class Paging {
	...
	// 총 게시글 수, 현제 페이지번호, 보여질 게시글 수, 보여질 페이지 수를 를 입력하는 생성자
	...
	private void makePaging() {
		...
		if (listCount == 0)
			setListCount(12); // 화면에 보여질 게시글의 기본 갯수 10
		if (pageCount == 0)
			setPageCount(10); // 화면에 보여질 페이지의 기본 갯수 10
